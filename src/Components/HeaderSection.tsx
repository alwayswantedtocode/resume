                ...
                <div className="flex-1 space-y-8">
                    <div className="space-y-6">
                        <motion.p
                            ...
                            className="text-lg font-medium bg-[#d4d5d4] text-grey-600 w-max flex items-center justify-center py-[7px] px-[10px]"
                        >
                            Hello, I&apos;m
                        </motion.p>
                        ...
                        <motion.p
                            ...
                            className="text-2xl text-gray-800 font-medium bg-[#d4d5d4] text-grey-600 w-max flex items-center justify-center py[7px] px-[10px]"
                        >
                    ...
                    >
                        <Link
                            href="#contact"
                            className="flex items-center justify-center gap-2 px-8 py-3 bg-gray-800 text-white rounded-lg shadow-lg hover:bg-gray-600 transition-all duration-300 hover:shadow-xl"
                        >
                        ...
                        <a
                            ...
                            className="flex items-center justify-center gap-2 px-8 py-3 border-2 border-gray-800 text-gray-800 rounded-lg hover:bg-blue-50 transition-all duration-300"
                        >
